...
const DisplayHome = () => {
  ...
  const [isSearching, setIsSearching] = useState(false); // ✅ Toggle for Search
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden">
      ...
      <div className="w-[75%] ml-[25%] h-screen bg-blue-900 flex flex-col">
        ...
        {/* SearchBar - When Clicked, Opens SearchPage */}
        <div className="bg-blue-900 px-6 py-3 sticky top-[60px] z-10 flex items-center gap-3 text-sm">
          ...
          {/* Search Bar (Clicking it Opens SearchPage) */}
          <div className="ml-auto" onClick={() => setIsSearching(true)}>
            <SearchBar />
          </div>
        </div>

        {/* ✅ If searching, show SearchPage instead */}
        {isSearching ? (
          <SearchPage setIsSearching={setIsSearching} />
        ) : (
